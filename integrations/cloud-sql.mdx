...
[Cloud SQL](https://cloud.google.com/sql) is Google Cloud's managed database service for PostgreSQL and MySQL. QueryBear connects over the standard wire protocol, giving your AI clients safe, read-only access through QueryBear's [security gateway](/security).
