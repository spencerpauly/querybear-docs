...
[Amazon RDS](https://aws.amazon.com/rds/) is AWS's managed relational database service. QueryBear connects to RDS for **PostgreSQL** and **MySQL** over the standard wire protocol, giving your AI clients safe, read-only access through QueryBear's [security gateway](/security).
