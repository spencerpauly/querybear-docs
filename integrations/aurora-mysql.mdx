...
[Amazon Aurora](https://aws.amazon.com/rds/aurora/) MySQL-Compatible Edition is AWS's high-performance managed MySQL. QueryBear connects over the standard MySQL protocol, giving your AI clients safe, read-only access through QueryBear's [security gateway](/security).
